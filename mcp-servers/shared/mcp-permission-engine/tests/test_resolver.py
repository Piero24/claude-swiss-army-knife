...
class TestPathResolver:
    ...
    def test_recursive_glob(self):
        ...
        assert resolver.resolve("/var/log/a/b/c/d/e/file.txt") == AccessLevel.READ
    ...
    def test_longest_match_wins(self):
        ...
        assert resolver.resolve("/var/www/admin/config.php") == AccessLevel.WRITE
    ...
    def test_explicit_deny_overrides_everything(self):
        resolver = PathResolver([
            ...
            PathRule(path="/var/www/admin/secrets/**", access=AccessLevel.NONE),
        ])
        # Explicit deny ALWAYS wins
        assert resolver.resolve("/var/www/admin/secrets/passwords.txt") == AccessLevel.NONE
